...
def main():
    ...
    try:
        ...
        # Display a sample of the created file
        print("\n" + "="*80)
        print("Sample of the 'cpi_series_master_list.csv' file:")
        print("="*80 + "\n")
        with pd.option_context('display.width', 120, 'display.max_columns', None):
            sample_filter = (master_df['area_name'] == 'U.S. city average') & \
                            (master_df['item_name'].str.contains('food', case=False))
            print(master_df[sample_filter].head(15))
