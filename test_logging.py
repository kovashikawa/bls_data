...
from bls_logging.config import setup_logging, get_logger, log_function_call, log_performance
...
def main():
    ...
    log.info("=" * 60)
    log.info("Check the 'logs' directory for log files with timestamps and function names")
